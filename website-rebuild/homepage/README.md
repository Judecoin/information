...
This folder contains the homepage rebuild materials for the new Judecoin official website.

The homepage is designed to present Judecoin as a privacy-focused digital cash network, a Proof of Stake and Service Node ecosystem, and a broader infrastructure layer for wallets, atomic swaps, explorer tools, roadmap development, and future applications.
