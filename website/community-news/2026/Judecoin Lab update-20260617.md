...
- Apple's system wallet and GUI wallet need to be redeveloped from the underlying code; for the system wallet, the Mac version needs to be completed first before the mobile version can be completed.
