...
Shared service nodes make it easy for users to participate in JUDE staking without running a full server themselves. Users can contribute to the security and operation of the Judecoin network while receiving rewards based on their contribution.

## Easily Stake

Judecoin staking is designed to make participation as quick and simple as possible.

Users who do not want to manage their own server can participate through a shared service node. Users who want to operate their own infrastructure can run a full Judecoin Service Node.
...
- the required staking amount;
- the wallet version used for staking;
- the service node registration status;
- the service node public information provided by the operator, if joining a shared service node;
- the expected lock-up conditions;
...
- a supported Linux server environment;
- sufficient storage, memory, network connectivity, and monthly traffic;
- open and reachable service node ports;
- the latest Judecoin service node binaries;
- a fully synchronized Judecoin daemon;
- a Judecoin wallet holding the required staking amount;
...
Detailed staking, setup, restart, recovery, security, backup, and status documentation is maintained in the [pos-evolution](https://github.com/Judecoin/pos-evolution) repository.

Related documents include:

- [Service Node Staking and Operation](https://github.com/Judecoin/pos-evolution/blob/main/service-node-staking.md)
- [Service Node Restart Process](https://github.com/Judecoin/pos-evolution/blob/main/service-node-restart.md)
...
- [Service Node Security and Backup Checklist](https://github.com/Judecoin/pos-evolution/blob/main/service-node-security-backup.md)
- [Service Node Status and Common FAQ](https://github.com/Judecoin/pos-evolution/blob/main/service-node-status-faq.md)
