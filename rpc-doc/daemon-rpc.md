...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_block_count"}' -H 'Content-Type: application/json'  
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"on_get_block_hash","params":[12345]}' -H 'Content-Type: application/json'

{
  "id": "0",
  "jsonrpc": "2.0",
  "result": "18d11db91ad8f6a4fb5e1d276043d90fb15ba8165b88ee7bd5403b0e6d2d7ca9"
}
```
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_block_template","params":{"wallet_address":"JDSPuG3AaCReEAyjkSviGsKhJ8uNHScYjfZWgA1t7bp48uVqr2k5MJQ8wJRCFP6LASHLcKNWxxMiWGAS7hWr3WopURSGBET","reserve_size":60}' -H 'Content-Type: application/json'

{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
    "blockhashing_blob": "0e0ebab5c5a1061dc917af1d4c22e0529fcbb7b2b098e7af380bf0f854daeafe0b0c1f76d8564a00000000180a80b0fb94e6a31d81237519d8db057fe100e398f18d7d28abf47cd973670301",
    "blocktemplate_blob": "",
    "difficulty": 43624293,
    "expected_reward": 120000000000,
    "height": 265825,
    "prev_hash": "1dc917af1d4c22e0529fcbb7b2b098e7af380bf0f854daeafe0b0c1f76d8564a",
    "reserved_offset": 128,
    "status": "OK",
    "untrusted": false
  }
...
* *block_header* - A structure containing block header information.
  ...
  * *reward* - unsigned int; The amount of new @atomic-units generated in this block and rewarded to the miner. Note: 1 JUDE = 1e12 @atomic-units.
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_last_block_header"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_block_header_by_hash","params":{"hash":"e22cf75f39ae720e8b71b3d120a5ac03f0db50bba6379e2850975b4859190bc6"}}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_block_header_by_height","params":{"height":912345}}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_block_headers_range","params":{"start_height":1545999,"end_height":1546000}}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_block","params":{"height":912345}}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_block","params":{"hash":"510ee3c4e14330a7b96e883c323a60ebd1b5556ac1262d0bc03c24a3b785516f"}}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_connections"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_info"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"hard_fork_info"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"set_bans","params":{"bans":[{"host":"192.168.1.51","ban":true,"seconds":30}]}}' -H  'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"set_bans","params":{"bans":[{"ip":838969536,"ban":true,"seconds":30}]}}' -H  'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_bans"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"flush_txpool","params":{"txids":["dc16fa8eaffe1484ca9014ea050e13131d3acf23b419f33bb4cc0b32b6c49308",""]}}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_output_histogram","params":{"amounts":[20000000000]}}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_coinbase_tx_sum","params":{"height":1563078,"count":2}}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_version"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_fee_estimate"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_alternate_chains"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"relay_tx","params":{"txids":["9fd75c429cbe52da9a52f2ffc5fbd107fe7fd2099c0d8de274dc8a67e0c98613"]}}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"sync_info"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_txpool_backlog"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_output_distribution","params":{"amounts":[628780000],"from_height":1462078}}' -H 'Content-Type: application/json'
...
For calls that end with **.bin**, the data is exchanged in the form of binary, serialized objects, as defined in the [Core RPC Server](https://github.com/JUDEcoin-project/JUDEcoin/blob/master/src/rpc/core_rpc_server_commands_defs.h).
...
```
$ curl http://127.0.0.1:16061/get_height -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/get_blocks.bin -d '{"block_ids":["d109a406528a7b44fef8bc03e75eaabb0f919f852884b43b550b8b3be80a49e7"],"start_height":1562062}' -H 'Content-Type: application/json'
...
```
$ echo -e '\x7B\x22\x68\x65\x69\x67\x68\x74\x73\x22\x3A\x5B\x31\x35\x36\x34\x32\x34\x36\x5D\x7D\x' | curl --data-binary @- http://127.0.0.1:16061/get_blocks_by_height.bin
$ echo -e '1564246' | curl --data-binary @- http://127.0.0.1:16061/get_blocks_by_height.bin
curl http://127.0.0.1:16061/get_blocks_by_height.bin --data-binary '{"heights":[1564246]}'
...
```
$ curl http://127.0.0.1:16061/get_hashes.bin -d '{"block_ids":["d109a406528a7b44fef8bc03e75eaabb0f919f852884b43b550b8b3be80a49e7"],"start_height":1562062}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/get_o_indexes.bin --data-binary '{"txid":"d6e48158472848e6687173a91ae6eebfa3e1d778e65252ee99d7515d63090408"}'
...
```
$ curl http://127.0.0.1:16061/get_transactions -d '{"txs_hashes":["d6e48158472848e6687173a91ae6eebfa3e1d778e65252ee99d7515d63090408"]}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/get_transactions -d '{"txs_hashes":["d6e48158472848e6687173a91ae6eebfa3e1d778e65252ee99d7515d63090408"],"decode_as_json":true}' -H 'Content-Type: application/json'
...
```
curl http://127.0.0.1:16061/get_transactions -d '{"txs_hashes":["d6e48158472848e6687173a91ae6eebfa3e1d778e65252ee99d7515d63090409"]}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/get_alt_blocks_hashes -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/is_key_image_spent -d '{"key_images":["8d1bd8181bf7d857bdb281e0153d84cd55a3fcaa57c3e570f4a49f935850b5e3","7319134bfc50668251f5b899c66b005805ee255c136f0e1cecbb0f3a912e09d4"]}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/send_raw_transaction -d '{"tx_as_hex":"de6a3...", "do_not_relay":false}' -H 'Content-Type: application/json'
```
...
```
$ curl http://127.0.0.1:16061/save_bc -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/get_peer_list -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/set_log_hash_rate -d '{"visible":true}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/set_log_level -d '{"level":1}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/set_log_categories -d '{"categories": "*:INFO"}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/set_log_categories -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/get_transaction_pool -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/get_transaction_pool_hashes.bin -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/get_transaction_pool_stats -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/stop_daemon -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/get_limit -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/set_limit -d '{"limit_down": 1024}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/out_peers -d '{"out_peers": 3232235535}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/out_peers -d '{"in_peers": 3232235535}' -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/start_save_graph -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/stop_save_graph -H 'Content-Type: application/json'
...
```
$ curl http://127.0.0.1:16061/update -d '{"command":"check"}' -H 'Content-Type: application/json'
